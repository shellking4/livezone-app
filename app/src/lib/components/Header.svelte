<script lang="ts">
    ...
    import CalBooking from "./CalBooking.svelte";
    ...
    //     const dropDownToggler: any = document.querySelector(
...
<header
    class="sticky text-2xl dark:bg-gray-900 top-0 z-20 backdrop-filter backdrop-blur"
>
    <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        ...
        >
            ...
            <div class="hidden w-50 md:w-full" id="navbar-dropdown">
                <ul
                    class="grid grid-cols-1 divide-y divide-gray-400 flex-col text-sm font-xs md:p-0 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700"
                >
                    <li>
                        <a
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
                <ul
                    class="flex justify-end divide-y divide-gray-100 flex-col text-[20px] font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700"
                >
                    <li>
                        <a
                            href="/#services_section"
