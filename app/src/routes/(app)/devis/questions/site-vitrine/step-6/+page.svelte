<script lang="ts">
    ...
    const handleNext = () => {
        ...
        goto("/devis/questions/site-vitrine/step-7")
    }
</script>
<div class="bg-gray-200">
    ...
    <div class="px-4 lg:w-full max-w-screen-xl lg:mx-auto mx-3 mt-10 lg:py-4 py-4 bg-white border border-white rounded-3xl shadow sm:p-16 dark:bg-gray-800 dark:border-gray-700">
        <img
            ...
            alt=""
        />
        <p class="mb-5 lg:text-lg text-md text-gray-900 font-normal mt-4 sm:text-lg dark:text-black-900">QUESTION 6 SUR 11</p>
        ...
        <p class="mb-5 lg:text-md text-sm text-gray-900 font-normal mt-4 dark:text-black-900">C'est le processus d'optimisation des sites web pour les moteurs de recherche.</p>
