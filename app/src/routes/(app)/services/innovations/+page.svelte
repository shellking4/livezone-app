<script>
    ...
    let giveLifeToIdeas = getServiceBySection("tab3_give_life_to_ideas");
    giveLifeToIdeas.expand = {};
    giveLifeToIdeas.expand.items = giveLifeToIdeas.expand?.items ? giveLifeToIdeas.expand?.items : [];

    let vrAr = getServiceBySection("tab3_vr_ar");
    vrAr.expand = {};
    vrAr.expand.items = vrAr.expand?.items ? vrAr.expand?.items : [];
</script>
...
<div>
    <section
        class="bg-cover bg-center w-full pb-16 bg-no-repeat bg-[url('/images/jeune-femme-creative-dans-casque-realite-virtuelle-maison-technologies-numeriques-du-futur_717906-1783.jpg')] bg-gray-700 bg-blend-multiply">
        ...
        >
            <div class="mr-auto place-self-center lg:col-span-7">
                ...
                >
                    Besoin d'innovations digitales ?
                </h1>
        ...
        <div class="text-sm bg-aftgroup max-w-screen-md hidden lg:block lg:absolute mt-6 mx-auto left-0 right-0 font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700">
    ...
    <section data-aos="fade-up" data-aos-duration="500" class="bg-white hidden lg:block mt-44 dark:bg-gray-900">
        <div class="gap-4 items-center px-2 mx-auto max-w-screen-xl xl:gap-32 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                ...
                <div class="py-8 px-4 mx-auto max-w-screen-lg sm:py-2 lg:px-6">
                    <div class="max-w-screen-xl mb-3 lg:mb-4">
                        ...
                        <p class="text-gray-800 text-lg dark:text-gray-400">
                            {@html giveLifeToIdeas.content}
                        </p>
                    </div>
                </div>
            </div>
            <img
                class="z-[0] hidden md:hidden lg:block lg:absolute ml-[40em] h-[24em] w-[40em] mt-11"
            ...
            <img
                ...
                alt="rectangle">
            <div style="background: linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.8) ), url('/images/personne-travaillant-html-ordinateur_23-2150038846.jpg') no-repeat; background-size: cover;"
                class="lg:z-[1] sm:-z-4 mt-10 flex mx-auto w-full px-1 lg:py-[10em] py-4 text-center text-white bg-white rounded-3xl border border-gray-100 shadow dark:border-gray-600 dark:bg-gray-800 dark:text-white"
            >
    ...
    <!-- first mobile -->
    <section class="bg-white lg:hidden sm:block mt-10 dark:bg-gray-900">
        <div class="gap-4 items-center max-w-screen-xl xl:gap-32 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
            ...
            <div style="background: linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.8) ), url('/images/contexte-programmation-personne-travaillant-codes-ordinateur_23-2150010125.jpg') no-repeat; background-size: fit;"
                class="z-[1] mt-10 absolute flex mx-auto w-full px-1 lg:py-20 py-[10em] text-center text-white bg-white rounded-3xl border border-gray-100 shadow dark:border-gray-600 dark:bg-gray-800 dark:text-white"
            >
                <ul class="max-w-lg space-y-4 text-gray-500 list-inside dark:text-gray-400">
            ...
            <div class="md:mt-0">
                <div class="py-8 px-4 mx-auto max-w-screen-lg sm:py-2 lg:px-6">
                    <div class="max-w-screen-xl mb-3 lg:mb-4">
                        ...
                        <p
                            class="text-gray-800 text-md dark:text-gray-400"
                        >
                            {@html vrAr.content}
                        </p>
                    </div>
    ...
    <!-- second mobile -->
    <section class="bg-white mb-[35em] lg:hidden sm:block mt-32 dark:bg-gray-900">
        <div class="gap-1 items-center mx-auto max-w-screen-xl xl:gap-32 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
            ...
            <img
                ...
                alt="rectangle">
            <div style="background: linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.8) ), url('/images/contexte-programmation-personne-travaillant-codes-ordinateur_23-2150010125.jpg') no-repeat; background-size: fit;"
                class="z-[1] absolute mt-10 flex mx-auto w-full lg:py-20 py-[10em] text-center text-white bg-white rounded-3xl border border-gray-100 shadow dark:border-gray-600 dark:bg-gray-800 dark:text-white"
            >
                <ul class="max-w-lg space-y-4 text-gray-500 list-inside dark:text-gray-400">
